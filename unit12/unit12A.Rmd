...
<font size=4 color=Blue face="微軟正黑">兩點發生成功事件機率皆在0.5~0.6之間，實際結果為一個成功(綠點)一個失敗(紅點)</font><br>
...
<font size=4 color=Blue face="微軟正黑">logistic function：母體發生成功事件(Y=1)的機率，P=Exp(fx)/(1+Exp(fx))，非線性函數</font><br>
