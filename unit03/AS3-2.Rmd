...
```{r}
plot(CK$Date, CK$StockPrice, type='l',main="GGGGG")  # 1973 1980
...
lines(PG$Date[121:385], PG$StockPrice[121:385],col="green", lwd=2)
lines(BE$Date[121:385],BE$StockPrice[121:385],type="l",lwd=1,col="blue")
lines(GE$Date[121:385],GE$StockPrice[121:385],type="l",lwd=1,col="orange")
lines(IBM$Date[121:385],IBM$StockPrice[121:385],type="l",lwd=1,col="purple")
abline(v = as.Date("2000-03-01"), lty=2, col='black')
abline(v = as.Date("1983-07-01"), lty=2, col='black')
legend("topleft",legend=c("Coke","P&G","BE","GE","IBM"),col=c("red","green","blue","orange","purple"),lwd=2,cex=0.8)
...
```{r}
plot(CK$Date[301:432],CK$StockPrice[301:432],main="So Difficult",xlab="Date",ylab="StockPrice",type="l",lwd=2,col="red",ylim=c(0,210))
lines(BE$Date[301:432],BE$StockPrice[301:432],type="l",lwd=1,col="green")
lines(GE$Date[301:432],GE$StockPrice[301:432],type="l",lwd=1,col="blue")
lines(IBM$Date[301:432],IBM$StockPrice[301:432],type="l",lwd=1,col="orange")
lines(PG$Date[301:432],PG$StockPrice[301:432],type="l",lwd=1,col="purple")
...
legend("topright",legend=c("Coke","Boe","GE","IBM","P&G"),col=c("red","green","blue","orange","purple"),lwd=3,cex=0.9)
