...
3. 是本公司會員，有飛行習慣(擁有所有群組裡最多的可用里程數)，但卻總是在其他聯盟公司消費→重點發展顧客
4. 對我們營收沒貢獻，但從非飛行交易次數多但非飛行里程數少，推測可能是利用聯盟公司頻繁飛短程的顧客→潛在短程顧客
5. 沒有飛行習慣→低價值顧客

#2.請你們為這五個族群各設計一個行銷策略
#Ans：
1.  第一群先試著找出他們改搭那些航空，然後用老會員專屬的活動或互動，提供比別家公司更優惠的方案，並提供轉乘優惠，使他們重新回來
2.  第二群屬於我們的VIP重點顧客，應確保我們的飛安與服務品質，使他們對我們產生品牌忠誠度
3.  第三群只要搭乘聯盟內轉乘相關的公司達到一定的里程數，就送往特定商業城市的免費機票
4.  搭乘聯盟內轉乘相關的公司達到幾次就可以累積額外里程數，或是獎項呢
5.  利用旅展，或是在連假時推出優惠價格，吸引此群顧客多體驗我們飛行，誘使加入會員，並在觀光旺季時提供以累積里程數來兌換免費旅館住宿，餐飲券之類
