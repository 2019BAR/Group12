...
<p class="wwl">
###<span style="font-size:24px">`r "\U1F605"` 學習重點：</span><br>  {data-height=250}
...
DEN = density(W, adjust = Adjust)  #1. 將變數向量轉為平滑線
...
#下注在 4.333~4.5、4.50~4.667、4.167~4.333、1.833~2.0、4.0~4.167、2.0~2.167
```
&nbsp; ■ &nbsp;你的賭金和期望值各是多少？<br>
```{r}
Adjust=0.5
